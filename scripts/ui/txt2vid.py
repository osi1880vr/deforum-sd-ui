...
def layoutFunc():
    ...
    with col1:
        ...
        with st.expander("Basic Settings", expanded=True):
            ...
            st.session_state["pathmode"] = st.selectbox('Path Structure', ("subfolders", "root"), value=st.session_state['defaults'].general.default_path_mode, help="subfolders structure will create daily folders plus many subfolders, root will use your outdir as root", key='pathmode-txt2vid')
