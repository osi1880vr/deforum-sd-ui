...
def layout():
    st.markdown(createHTMLGallery(), unsafe_allow_html=True)
...
def createHTMLGallery():
  ...
  <script id="code">
    function init() {
      ...
      // taken from https://unpkg.com/gojs@2.2.15/extensions/Figures.js:
  ...
  <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700&amp;swap" rel="stylesheet" type="text/css">
      <p><a href="https://github.com/NorthwoodsSoftware/GoJS/blob/master/samples/flowchart.html" target="_blank">View this sample page's source on GitHub</a></p></div>
    </body>
    </html>
    """
    return html3