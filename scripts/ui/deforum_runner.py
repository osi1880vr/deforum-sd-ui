...
class runner:
    ...
    def get_args(self, data):
        ...
        DeforumArgs = {'image': data['preview_image'],
                       ...
                       'strength_0_no_init': data['strength_0_no_init'],
                       ...
                       'use_alpha_as_mask': data['use_alpha_as_mask'],
        ...
        DeforumAnimArgs = {'animation_mode': data['animation_mode'],
                           ...
                           'flip_2d_perspective': data['flip_2d_perspective'],  # @param {type:"boolean"}
                           'perspective_flip_theta': data['perspective_flip_theta'],  # @param {type:"string"}
                           'perspective_flip_phi': data['perspective_flip_phi'],  # @param {type:"string"}
                           'perspective_flip_gamma': data['perspective_flip_gamma'],  # @param {type:"string"}
                           'perspective_flip_fv': data['perspective_flip_fv'],  # @param {type:"string"}
                           'strength_schedule': data['strength_schedule'],  # @param {type:"string"}
                           'contrast_schedule': data['contrast_schedule'],  # @param {type:"string"}

                           # @markdown ####**Coherence:**
                           'color_coherence': data['color_coherence'],
                           # @param ['None', 'Match Frame 0 HSV', 'Match Frame 0 LAB', 'Match Frame 0 RGB'] {type:'string'}
                           'diffusion_cadence': data['diffusion_cadence'],
