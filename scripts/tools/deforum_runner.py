...
class runner:
	...
	def get_args(self):
		...
		W, H = map(lambda x: x - x % 64,
				   (st.session_state['W'], st.session_state['H']))  # resize to integer multiple of 64
		...
		DeforumAnimArgs = {'animation_mode': st.session_state['animation_mode'],
						   ...
						   'perspective_flip_theta': st.session_state['perspective_flip_theta'],
						   # @param {type:"string"}
						   'perspective_flip_phi': st.session_state['perspective_flip_phi'],  # @param {type:"string"}
						   'perspective_flip_gamma': st.session_state['perspective_flip_gamma'],
						   # @param {type:"string"}
						   ...
						   'interpolate_key_frames': st.session_state['interpolate_key_frames'],
						   # @param {type:"boolean"}
						   'interpolate_x_frames': st.session_state['interpolate_x_frames'],  # @param {type:"number"}

						   # @markdown ####**Resume Animation:**
						   'resume_from_timestring': st.session_state['resume_from_timestring'],
						   # @param {type:"boolean"}
